...
class Assembler {
    ...
    go(input: string) {
        ...
        var normalizedLabels: { [key: string]: number } = {};

        // Split text into code lines
        var lines = input.split('\n');

        // Allowed formats: 200, 200d, 0xA4, 0o48, 101b
        var parseNumber = function (input: string) {
        ...
        var parseRegister = function (input: string) {
        ...
        var parseOffsetAddressing = function (input: string) {
            input = input.toUpperCase();
            var m = 0;
            var base = 0;
        ...
        var parseRegOrNumber = function (input: string, typeReg: string, typeNumber: string) {
        ...
        var parseLabel = function (input: string) {
            return regexLabel.exec(input) ? input : undefined;
        };

        var getValue = function (input: string) {
        ...
        var addLabel = function (label: string) {
        ...
        var checkNoExtraArg = function (instr: string, arg: any) {
            if (arg !== undefined) {
                throw instr + ": too many arguments";
            }
        };

        var pushVal = function (value: any) {
            if (isNaN(value)) {
                code.push(value, 0);
            }
            else {
